...
hero:
  name: "Reasoning Kingdom"
  text: "An Open-Source Tutorial on AI Reasoning"
  tagline: From entropy to boundaries, questioning the nature of intelligence
  image:
    src: /ReasoningKingdom.png
    alt: Reasoning Kingdom
  actions:
    - theme: brand
      text: Prequel
      link: /en/dear-reasoner/preface
    - theme: alt
      text: Volume I
      link: /en/volume1/preface/
    - theme: alt
      text: Volume II
      link: /en/volume2/preface/

features:
  - title: Prequel (Ch1–18)
